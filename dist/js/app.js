...
/***/ function(module, exports, __webpack_require__) {
	...
	var _onlineUsers = __webpack_require__(190);
	...
	var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.applyMiddleware)((0, _reduxLogger2.default)(), _socket.socketMiddleware));

	socket.setDispatch(store.dispatch);

	store.dispatch((0, _onlineUsers.getUsers)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../raw-loader/index.js!./bootstrap.min.css", function() {
				var newContent = require("!!./../../../raw-loader/index.js!./bootstrap.min.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../raw-loader/index.js!./font-awesome.min.css", function() {
				var newContent = require("!!./../../raw-loader/index.js!./font-awesome.min.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _onlineUsers = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function onlineUsers() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? new Map() : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _ActionTypes.ONLINE_USER_ADD:
	            state.set(action.user.id, action.user);
	            return new Map(state);

	        case _ActionTypes.USER_OFFLINE:
	...
	socket.on('new_user', function (dispatch, data) {
	    dispatch((0, _onlineUsers.addOnlineUser)(data));
	});
...
/***/ function(module, exports) {
	...
	var ONLINE_USER_ADD = exports.ONLINE_USER_ADD = 'ONLINE_USER_ADD';
	var USER_OFFLINE = exports.USER_OFFLINE = 'USER_OFFLINE';
	var ONLINE_USER_SELECT = exports.ONLINE_USER_SELECT = 'ONLINE_USER_SELECT';
...
/***/ function(module, exports, __webpack_require__) {
	...
	function addOnlineUser(user) {
	    return { type: _ActionTypes.ONLINE_USER_ADD, user: user };
	}

	function userOffline(id) {
	    return { type: _ActionTypes.USER_OFFLINE, id: id };
	}

	function getUsers() {
	    return {
	        ws: function ws(socket, dispatch) {
	            socket.send('get_users').then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var socket = new _Socket2.default('ws://127.0.0.1:5736');

	function getSocket() {
	    return socket;
	}

	function socketMiddleware(_ref) {
...
/***/ function(module, exports) {
	...
	var Socket = function () {
	    function Socket(url) {
	        ...
	        ws.onopen = function () {
	            _this.waits.forEach(function (resolve) {
	                return resolve();
	            });
	        };
	    }
	    ...
	    _createClass(Socket, [{
	        ...
	        value: function send(event) {
	            ...
	            return this.fetch().then(function () {
	                ...
	                if (typeof event === 'string') {
	                    data = { token: token, event: event, data: data };
	                } else {
	                    data.token = token;
	                }
	        ...
	        value: function onMessage(json) {
	            ...
	            if (event && events.has(event)) {
	                events.get(event).forEach(function (cb) {
	                    return cb(_this2.dispatch, data);
	                });
	            }
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatHistory = __webpack_require__(194);

	var _ChatHistory2 = _interopRequireDefault(_ChatHistory);

	var _OnlineUsers = __webpack_require__(197);

	var _OnlineUsers2 = _interopRequireDefault(_OnlineUsers);

	var _NewChats = __webpack_require__(199);

	var _NewChats2 = _interopRequireDefault(_NewChats);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_ChatHistory2.default, null)
	                ),
	                _react2.default.createElement(
	                    'div',
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-lg-3 col-md-3 col-sm-3' },
	                    _react2.default.createElement(_NewChats2.default, null)
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatMessageMy = __webpack_require__(195);

	var _ChatMessageMy2 = _interopRequireDefault(_ChatMessageMy);

	var _ChatMessageUser = __webpack_require__(196);
	...
	var ChatHistory = function (_Component) {
	    ...
	    _createClass(ChatHistory, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'chat-box-div' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'chat-box-head' },
	                    'GROUP CHAT HISTORY'
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'panel-body chat-box-main' },
	                    _react2.default.createElement(_ChatMessageMy2.default, { message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' }),
	                    _react2.default.createElement(_ChatMessageUser2.default, { avatar: 'https://randomuser.me/api/portraits/thumb/men/29.jpg', name: 'whiteswan373', message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' }),
	                    _react2.default.createElement(_ChatMessageMy2.default, { message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' }),
	                    _react2.default.createElement(_ChatMessageUser2.default, { avatar: 'https://randomuser.me/api/portraits/thumb/men/29.jpg', name: 'whiteswan373', message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' }),
	                    _react2.default.createElement(_ChatMessageUser2.default, { avatar: 'https://randomuser.me/api/portraits/thumb/women/29.jpg', name: 'whiteswan373', message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Enter Text Here...' }),
	                        _react2.default.createElement(
	                            'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatMessageMy = function (_Component) {
	    _inherits(ChatMessageMy, _Component);

	    function ChatMessageMy() {
	        _classCallCheck(this, ChatMessageMy);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ChatMessageMy).apply(this, arguments));
	    }

	    _createClass(ChatMessageMy, [{
	        key: 'render',
	        value: function render() {
	            var message = this.props.message;


	            var avatar = 'https://randomuser.me/api/portraits/thumb/men/72.jpg';
	            var name = 'Justine Goliyad';
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'chat-box-name-right' },
	                    _react2.default.createElement('img', { src: avatar, className: 'img-circle' }),
	                    '- ',
	                    name
	                ),
	                _react2.default.createElement('hr', { className: 'hr-clas' })
	            );
	        }
	    }]);

	    return ChatMessageMy;
	}(_react.Component);

	exports.default = ChatMessageMy;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatMessageUser = function (_Component) {
	    _inherits(ChatMessageUser, _Component);

	    function ChatMessageUser() {
	        _classCallCheck(this, ChatMessageUser);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ChatMessageUser).apply(this, arguments));
	    }

	    _createClass(ChatMessageUser, [{
	        key: "render",
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OnlineUsersItem = __webpack_require__(198);

	var _OnlineUsersItem2 = _interopRequireDefault(_OnlineUsersItem);
	...
	var OnlineUsers = function (_Component) {
	    _inherits(OnlineUsers, _Component);

	    function OnlineUsers() {
	        _classCallCheck(this, OnlineUsers);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(OnlineUsers).apply(this, arguments));
	    }

	    _createClass(OnlineUsers, [{
	        key: 'getUserList',
	        value: function getUserList(users) {
	            var data = [];

	            users.forEach(function (user) {
	                data.push(_react2.default.createElement(_OnlineUsersItem2.default, { key: user.id, id: user.id, name: user.username, avatar: user.picture.thumbnail }));
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnlineUsersItem = function (_Component) {
	    _inherits(OnlineUsersItem, _Component);

	    function OnlineUsersItem() {
	        _classCallCheck(this, OnlineUsersItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(OnlineUsersItem).apply(this, arguments));
	    }

	    _createClass(OnlineUsersItem, [{
	        key: "onClickHandle",
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                { href: "#", onClick: function onClick(e) {
	                        return _this2.onClickHandle(e);
	                    } },
	                _react2.default.createElement(
	                    "div",
	                    { className: "chat-box-online-left" },
	                    _react2.default.createElement("img", { src: avatar, className: "img-circle" }),
	                    _react2.default.createElement(
	                        "span",
	                        { className: "username" },
	                ...
	                _react2.default.createElement("hr", { className: "hr-clas-low" })
	            );
	        }
	    }]);

	    return OnlineUsersItem;
	}(_react.Component);

	exports.default = OnlineUsersItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewChatsItem = __webpack_require__(200);

	var _NewChatsItem2 = _interopRequireDefault(_NewChatsItem);
	...
	var NewChats = function (_Component) {
	    _inherits(NewChats, _Component);

	    function NewChats() {
	        _classCallCheck(this, NewChats);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NewChats).apply(this, arguments));
	    }

	    _createClass(NewChats, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'chat-box-new-div' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'chat-box-new-head' },
	                    'NEW CHATS (',
	                    count,
	                    ')'
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'panel-body chat-box-new' },
	                    _react2.default.createElement(_NewChatsItem2.default, { id: 72, avatar: 'https://randomuser.me/api/portraits/thumb/men/72.jpg', username: 'whiteswan373' }),
	                    _react2.default.createElement(_NewChatsItem2.default, { id: 29, avatar: 'https://randomuser.me/api/portraits/thumb/women/29.jpg', username: 'organi571' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewChatsItem = function (_Component) {
	    _inherits(NewChatsItem, _Component);

	    function NewChatsItem() {
	        _classCallCheck(this, NewChatsItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NewChatsItem).apply(this, arguments));
	    }

	    _createClass(NewChatsItem, [{
	        key: "onClickHandle",
	        value: function onClickHandle(e) {
	            e.preventDefault();
	            console.log(this.props.id);
